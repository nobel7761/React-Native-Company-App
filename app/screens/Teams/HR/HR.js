...
function HR() {
    return (
        ...
        <Tab.Navigator screenOptions={tabOptions}>
            ...
            <Tab.Screen name='HR1' component={people1} options={{
                tabBarIcon: (focused, tintColor) => (
                    <Image style={{ width: 25, height: 25 }}
                        source={require('../../../../assets/01.jpg')} />
                ),
            }} />
            <Tab.Screen name='HR2' component={people2} options={{
                tabBarIcon: (focused, tintColor) => (
                    <Image style={{ width: 25, height: 25 }}
                        source={require('../../../../assets/02.jpg')} />
                ),
            }} />
            <Tab.Screen name='HR3' component={people3} options={{
                tabBarIcon: (focused, tintColor) => (
                    <Image style={{ width: 25, height: 25 }}
                        source={require('../../../../assets/03.jpg')} />
                ),
            }} />
            <Tab.Screen name='HR4' component={people4} options={{
                tabBarIcon: (focused, tintColor) => (
                    <Image style={{ width: 25, height: 25 }}
                        source={require('../../../../assets/04.jpg')} />
                ),
            }} />
            <Tab.Screen name='HR5' component={people5} options={{
                tabBarIcon: (focused, tintColor) => (
                    <Image style={{ width: 25, height: 25 }}
                        source={require('../../../../assets/05.jpg')} />
                ),
            }} />
            <Tab.Screen name='HR6' component={people6} options={{
                tabBarIcon: (focused, tintColor) => (
                    <Image style={{ width: 25, height: 25 }}
                        source={require('../../../../assets/06.jpg')} />
                ),
            }} />
            <Tab.Screen name='HR7' component={people7} options={{
                tabBarIcon: (focused, tintColor) => (
                    <Image style={{ width: 25, height: 25 }}
                        source={require('../../../../assets/07.jpg')} />
                ),
            }} />
            <Tab.Screen name='HR8' component={people8} options={{
                tabBarIcon: (focused, tintColor) => (
                    <Image style={{ width: 25, height: 25 }}
                        source={require('../../../../assets/08.jpg')} />
                ),
            }} />
            <Tab.Screen name='HR9' component={people9} options={{
                tabBarIcon: (focused, tintColor) => (
                    <Image style={{ width: 25, height: 25 }}
                        source={require('../../../../assets/09.jpg')} />
                ),
            }} />
            <Tab.Screen name='HR10' component={people10} options={{
                tabBarIcon: (focused, tintColor) => (
                    <Image style={{ width: 25, height: 25 }}
