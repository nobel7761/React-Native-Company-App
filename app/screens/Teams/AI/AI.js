...
function AI() {
    return (
        ...
        <Tab.Navigator screenOptions={tabOptions}>
            ...
            <Tab.Screen name='AI1' component={people1} options={{
                tabBarIcon: (focused, tintColor) => (
                    <Image style={{ width: 25, height: 25 }}
                        source={require('../../../../assets/01.jpg')} />
                ),
            }} />
            <Tab.Screen name='AI2' component={people2} options={{
                tabBarIcon: (focused, tintColor) => (
                    <Image style={{ width: 25, height: 25 }}
                        source={require('../../../../assets/02.jpg')} />
                ),
            }} />
            <Tab.Screen name='AI3' component={people3} options={{
                tabBarIcon: (focused, tintColor) => (
                    <Image style={{ width: 25, height: 25 }}
                        source={require('../../../../assets/03.jpg')} />
                ),
            }} />
            <Tab.Screen name='AI4' component={people4} options={{
                tabBarIcon: (focused, tintColor) => (
                    <Image style={{ width: 25, height: 25 }}
                        source={require('../../../../assets/04.jpg')} />
                ),
            }} />
            <Tab.Screen name='AI5' component={people5} options={{
                tabBarIcon: (focused, tintColor) => (
                    <Image style={{ width: 25, height: 25 }}
                        source={require('../../../../assets/05.jpg')} />
                ),
            }} />
            <Tab.Screen name='AI6' component={people6} options={{
                tabBarIcon: (focused, tintColor) => (
                    <Image style={{ width: 25, height: 25 }}
                        source={require('../../../../assets/06.jpg')} />
                ),
            }} />
            <Tab.Screen name='AI7' component={people7} options={{
                tabBarIcon: (focused, tintColor) => (
                    <Image style={{ width: 25, height: 25 }}
                        source={require('../../../../assets/07.jpg')} />
                ),
            }} />
            <Tab.Screen name='AI8' component={people8} options={{
                tabBarIcon: (focused, tintColor) => (
                    <Image style={{ width: 25, height: 25 }}
                        source={require('../../../../assets/08.jpg')} />
                ),
            }} />
            <Tab.Screen name='AI9' component={people9} options={{
                tabBarIcon: (focused, tintColor) => (
                    <Image style={{ width: 25, height: 25 }}
                        source={require('../../../../assets/09.jpg')} />
                ),
            }} />
            <Tab.Screen name='AI10' component={people10} options={{
                tabBarIcon: (focused, tintColor) => (
                    <Image style={{ width: 25, height: 25 }}
